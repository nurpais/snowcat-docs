  ...
  },
  {
    ...
    links: [
      { title: 'Get Started', href: '/docs/get-started' },
      {
        ...
        href: '/docs/collecting-data',
      },
      { title: 'Authoring Schemas', href: '/docs/authoring-schemas' },
    ],
  },
  {
    title: 'Iceberg',
  ...
  return (
    ...
    */}
      ...
      <div className="relative mx-auto flex max-w-[1572px] justify-center sm:px-2 lg:px-8 xl:px-12">
        ...
        <div className="min-w-0 max-w-3xl flex-auto px-4 py-16 lg:max-w-none lg:pr-0 lg:pl-8 xl:px-16">
          <article>
            {(title || section) && (
